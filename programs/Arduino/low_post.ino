...
int count1, count2, count4, S, p1, feedernumber, optnumber;
int count3=0;
      ...
      if(digitalRead(PORKING1)==HIGH&&F1flag==false){
        ...
        if(feedernumber==1){
          ...
          for (int i1=0; i1<=20; i1++){
            digitalWrite(PWMopt,HIGH);
            delay(10);
            digitalWrite(PWMopt,LOW);
            delay(40);
          }
        }else{
          Serial.println("f1");
